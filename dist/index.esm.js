...
var Icon$B = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 80 80" }, props),
        React.createElement("g", { clipPath: "url(#clip0)" },
            ...
            React.createElement("path", { d: "M35.9629 36.0654L46.0085 38.7571L37.0016 72.3714L26.956 69.6797L35.9629 36.0654Z", fill: "#5eecff" }),
            React.createElement("path", { d: "M11.8535 53.0029L14.5452 42.9573L61.111 55.4346L58.4193 65.4802L11.8535 53.0029Z", fill: "#5eecff" }),
            React.createElement("g", { style: { mixBlendMode: "multiply" } },
                React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M30.0918 57.9047L40.1732 60.606L39.7591 62.1515L29.6777 59.4502L30.0918 57.9047ZM42.8724 50.5325L32.791 47.8312L33.2051 46.2857L43.2865 48.987L42.8724 50.5325Z", fill: "#5eecff" })),
            ...
            React.createElement("path", { d: "M31.4707 20.8506L41.5163 18.1589L45.1398 31.6818L35.0942 34.3735L31.4707 20.8506Z", fill: "#5eecff" }),
            React.createElement("g", { style: { mixBlendMode: "multiply" } },
                React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M31.9671 22.5998L41.9672 19.7998L41.5673 17.9998L31.3975 20.8215L31.9671 22.5998Z", fill: "#5eecff" }))),
        React.createElement("defs", null,
...
var shadows = {
    ...
    focus: "0px 0px 0px 1px #5eecff, 0px 0px 0px 4px rgba(118, 69, 217, 0.6)",
...
var Logo = function (_a) {
    ...
    return (React.createElement(LogoImage, null,
        React.createElement("img", { src: '/images/egg/LogoTextNewWhite.png', alt: 'WaterDendy' })));
};
...
var Menu = function (_a) {
    ...
    var chartEx = "https://www.dextools.io/app/en/arbitrum/pair-explorer/0xafbe0dfa1f3ab8cc32e3b80aec1398db3ba127e1";
    return (React.createElement(Wrapper$1, null,
            ...
            React.createElement(DLInfoContainer, null,
                React.createElement(InfoBoxes, null,
                    React.createElement(Link, { href: "/", target: "_blank" },
                        React.createElement("img", { className: "navImg", src: '/images/egg/LogoTextNewWhite.png', alt: "WaterDendy" }))),
                React.createElement("div", { className: "badges" },
                    React.createElement(InfoBoxes, null,
                        React.createElement(Link, { href: "https://t.me/WaterDendy", target: "_blank" },
                            React.createElement("img", { className: "navImg WaterDendy", src: "/images/egg/logo4.png", alt: "TG" }))),
                    React.createElement(InfoBoxes, null,
                        React.createElement(Link, { href: "https://twitter.com/defi_waterfall", target: "_blank" },
                            React.createElement("img", { className: "navImg WaterDendy", src: "/images/egg/logo2.png", alt: "Twitter" }))))),
        ...
        React.createElement(MenuWrapper, null,         
            React.createElement(StyledLinkTag, { href: "https://docs-dendy.defiwaterfall.com/", target: "_blank" },
                React.createElement("div", { className: "menu-icons" },
                    React.createElement("img", { className: "menu-pic", alt: "docs", src: "https://pbs.twimg.com/profile_images/1588068576837107713/IZbm66Zo_400x400.jpg" }),
                    " ",
                    React.createElement("span", { className: "menu-text" }, "DOCS"))),
            React.createElement(StyledLinkTag, { href: "https://www.dextools.io/app/en/arbitrum/pair-explorer/0xafbe0dfa1f3ab8cc32e3b80aec1398db3ba127e1", target: "_blank" },
                React.createElement("div", { className: "menu-icons" },
            ...
            React.createElement(StyledLinkTag, { href: "https://app.camelot.exchange/?token2=0x88692aD37c48e8F4c821b71484AE3C2878C2A2C6", target: "_blank" },
                React.createElement("div", { className: "menu-icons" },
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", tertiary: "#EFF4F5", text: "#fff", textDisabled: "#BDC2C4", textSubtle: "#ffc100", borderColor: "#E9EAEB", card: "rgba(0,0,0,0.75)", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#da3b2e", background: "#343135", backgroundDisabled: "#3c3742", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#483f5a", primaryDark: "#0098A1", tertiary: "#353547", text: "#965cff", textDisabled: "#666171", textSubtle: "#c9c4d4", borderColor: "#524B63", card: "#05010d4a", gradients: {
